AUCTIONATOR_LOCALES.enUS = function()
  ...
  L["CONFIG_SELLING_ICON_SIZE"] = "Bag icon size"
  L["CONFIG_SELLING_ICON_SIZE_TOOLTIP_HEADER"] = "Size of Icons"
  L["CONFIG_SELLING_ICON_SIZE_TOOLTIP_TEXT"] = "This lets you make the bag item icons in the selling tab larger or smaller. Default size is 42."
  L["CONFIG_BAG"] = "Bag"
  return L
end
